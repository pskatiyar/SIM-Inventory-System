...
<div id="content">
<form name="form1" action="<%=request.getContextPath()%>/BillProcessorController" method="post">
Service Provider Id
<input type="text" name="serviceproviderid"/><br></br>
<input type="submit" name="option" value="View Customer List"/>
