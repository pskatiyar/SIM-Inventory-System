...
<%@page import="com.tcs.ilp.t210.model.*"%>
...
<%ArrayList<CustomerBean>serviceProviderCustomerList=(ArrayList<CustomerBean>)session.getAttribute("serviceProviderCustomerList");
for(CustomerBean current:serviceProviderCustomerList)
{%>
<tr>
