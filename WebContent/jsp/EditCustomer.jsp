<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.tcs.ilp.t210.dao.*, com.tcs.ilp.t210.model.*"%>
...
<form method="post" action="<%=request.getContextPath() %>/BillProcessorController" name="Customer" onSubmit="return Valid();">
<%String currentCustomerId=(String)request.getAttribute("customer");
if(currentCustomerId!=null)
{
	long editCustomerId=Long.parseLong(currentCustomerId);
	currentCustomer=customerDao.getCustomerById(editCustomerId);
	%>
	<table>
	<tr>
	<td>Customer Id</td>
	<td><input type="text" name="customerId" readonly="readonly" value="<%=currentCustomer.getCustomerId()%>"/></td>
	</tr>
	<tr>
	<td>Customer Name</td>
	<td><input type="text" name="customerName" value="<%=currentCustomer.getCustomerName()%>" onblur="CustName()"/></td>
	<td id="1" style="color: red"></td>
	</tr>
	<tr>
	<td>Customer Address</td>
	<td><textarea rows="4" cols="25" name="customerAddress" onblur="CustAddress()"><%=currentCustomer.getCustomerAddress() %></textarea></td>
	<td id="2" style="color: red"></td>
	</tr>
	<tr>
	<td>Document Status</td>
	<td><input type="radio" name="customerStatus" value="Verified" checked="checked"/>Verified
	<input type="radio" name="customerStatus" value="Not Verified"/>Not Verified</td>
	</tr>
	<tr>
	<td><input type="submit" name="option" value="Update"/></td>
	<td><input type="reset" value="Reset" onclick="location.reload()" /></td>
	<td><button onclick="window.location.href='<%=request.getContextPath() %>/jsp/CustomerHome.jsp'">Back</button></td>
	</tr>
	</table>
<%} 
else
